                                          ...
                                          <div class="col-12 mt-3">
                                             <div class="row g-1">
                                                ...
                                                <div class="col-8 offset-2 col-lg-3 offset-lg-1 mb-3 mt-2 shadow rounded-4">
                                                   <select class="form-select border-end-0 border-start-0 border-top-0 mt-3 mb-3" id="category" onchange="brand_load();">
                                                ...
                                                <div class="col-7 offset-5 col-lg-3 offset-lg-1 mb-3 mt-2 shadow rounded-4">
                                                   <select class="form-select border-end-0 border-start-0 border-top-0 mt-3 mb-3" id="brand" onchange="load_model();">
