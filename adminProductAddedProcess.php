...
$seller_rs = Database::search("SELECT * FROM `user` WHERE `email`='".$sellerEmail."'");
...
//   if($seller_data["email"] == $)
  ...
  `brand_has_model_id`,`condition_id`,`status_id`,`user_email`) VALUES ('" . $cost . "','" . $qty . "','" . $text . "','" . $title . "','" . $date . "','" . $dcwc . "',
  '" . $dcoc  . "','" . $color . "','" . $category . "','" . $brand_has_model_id. "','" . $condition. "','" .$status . "','".$sellerEmail."')");
